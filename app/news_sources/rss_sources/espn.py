...
class ESPNScraper:
    ...
    def fetch_article_links(cls):
        ...
        try:
            for section_url in cls.SECTION_URLS:
                ...
                logger.info(
                    f"Fetching links from: {section_url}"
                )
            ...
            logger.error(
                f"Failed fetching ESPN links: {e}"
            )
    ...
    def run_pipeline(input_data=None):
        try:
            ...
            article_links = (
                ESPNScraper.fetch_article_links()
            )
            ...
            result = (
                SupabaseClient.insert_articles(
                    all_articles
                )
            )
