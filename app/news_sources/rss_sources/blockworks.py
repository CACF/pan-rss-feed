...
class BlockworksRSSPipeline:
    ...
    def run_pipeline(input_data=None):
        """Run the Blockworks RSS pipeline and insert into MongoDB."""
        start = time.perf_counter()
        articles = BlockworksRSSPipeline.process_input(input_data)
        ...
        logger.info(f"Blockworks pipeline finished in {result['elapsed_time']}s")
        return result
