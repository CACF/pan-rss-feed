...
HOUSTANPULSE_TABLE = os.getenv("HOUSTANPULSE_TABLE", TABLE_NAME)
MEDIANEST_TABLE = os.getenv("MEDIANEST_TABLE", TABLE_NAME)
MEDIANESTDEV_TABLE = os.getenv("MEDIANESTDEV_TABLE", TABLE_NAME)
MERAMUREE_TABLE = os.getenv("MERAMUREE_TABLE", TABLE_NAME)
...
SUPABASE_HOUSTANPULSE_URL = os.getenv("SUPABASE_HOUSTANPULSE_URL", "")
SUPABASE_HOUSTANPULSE_KEY = os.getenv("SUPABASE_HOUSTANPULSE_KEY", "")
...
SUPABASE_MERAMUREE_URL = os.getenv("SUPABASE_MERAMUREE_URL", "")
SUPABASE_MERAMUREE_KEY = os.getenv("SUPABASE_MERAMUREE_KEY", "")
