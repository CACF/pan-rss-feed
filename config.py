...
HOUSTONPULSE_TABLE = os.getenv("HOUSTONPULSE_TABLE", os.getenv("HOUSTANPULSE_TABLE", TABLE_NAME))
...
MERAMURREE_TABLE = os.getenv("MERAMURREE_TABLE", os.getenv("MERAMUREE_TABLE", TABLE_NAME))
