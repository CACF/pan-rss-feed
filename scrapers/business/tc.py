...
class TradeChronicleRSSPipeline:
    ...
    def clean_content(content_html):
        ...
        try:
            ...
            for tag in soup(
                ["script", "style", "iframe", "noscript", "img", "figure", "form"]
            ):
                tag.decompose()
    ...
    def full_description(link):
        ...
        try:
            res = requests.get(
                link,
                timeout=30,
                headers=get_random_headers(TradeChronicleRSSPipeline.HEADERS),
            )
            try:
        ...
        try:
            ...
            def process_item(item):
                try:
                    ...
                    logger.info(f"Title={title} | Tags={tags} | Genre={genre}")
            ...
            with concurrent.futures.ThreadPoolExecutor(
                max_workers=TradeChronicleRSSPipeline.MAX_WORKERS
            ) as executor:
