...
from .keywords import PESHAWAR_KEYWORDS
from .feeds import GOOGLE_NEWS_FEEDS, GENERAL_NATIONAL_FEEDS
...
class PeshawarRSSPipeline:
    ...
    def is_peshawar_related(text):
        lower = text.lower()
        return any(kw in lower for kw in PESHAWAR_KEYWORDS)
    ...
    def process_item(
        ...
        **kwargs,
        ...
        try:
            ...
            source = resolve_source(item, PeshawarRSSPipeline.SOURCE)
    ...
    def run_pipeline(input_data=None, table_name=None):
        ...
        try:
            ...
            logger.error(f"Peshawar Pulse pipeline failed: {e}")
            return {
                "inserted_count": 0,
                "total_articles": 0,
                "error": str(e),
